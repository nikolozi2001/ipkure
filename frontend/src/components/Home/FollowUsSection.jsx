...
const FollowUsSection = () => {
  ...
  const translations = {
    ...
    ge: {
      ...
      instagramHandle: "ipkure@112",
      subtitle: "აღმოაჩინეთ ჩვენი უახლესი კოლექციები და კულისებს მიღმა მომენტები",
  ...
  const productImages = [
    ...
    { src: womanPerfume, alt: t.altTexts.womanPerfume, likes: "1.8k", comments: "56" },
    { src: manPerfume, alt: t.altTexts.manPerfume, likes: "3.2k", comments: "124" },
    ...
    <section className="bg-gradient-to-br from-gray-50 via-white to-purple-50 py-16 lg:py-24 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          {productImages.map((image, index) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="mt-2">
                  <p className="text-sm font-medium text-gray-800">{image.likes} likes</p>
        ...
        <div className="text-center mt-16">
          ...
          >
            {language === "en" ? "Join our community of fragrance lovers" : "შემოუერთდით ჩვენს არომატების მოყვარულთა საზოგადოებას"}
          </p>
          <a 
            href="https://www.instagram.com/ipkure@112" 
            target="_blank" 
